 ...
 ** follows.  (LMNO uses no global variables and makes little use of
...
struct lmno
{
	...
	char *copyright;		// user copyright notice
	int  copyrightln;		// Line number for start of copyright notice
	...
	int export_c;			 // Output C code, rather than C++
